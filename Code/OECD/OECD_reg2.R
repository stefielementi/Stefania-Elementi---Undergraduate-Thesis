# Script: OECD_reg2.R
# Purpose: Regression 2 on OECD Episode Classification
# Input: Data/Clean Data/full_OECD_dataset.csv
# Output: Output/OECD_reg2.tex
...
latex_lines <- c(
  "\\begin{table}[!htbp]",
  "\\centering",
  "\\caption{Probability that adjustment is continued from previous year (OECD Episode Identification)}",
...
writeLines(latex_lines, "Output/OECD_reg2.tex")