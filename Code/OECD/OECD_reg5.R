# Script: OECD_reg5.R
# Purpose: Regression 5 on OECD Episode Classification
# Input: Data/Clean Data/full_OECD_dataset.csv
# Output: Output/OECD_reg5.tex
...
latex_lines <- c(
  "\\begin{table}[!htbp]",
  "\\centering",
  "\\caption{Size of cumulated adjustment during episode (OECD Episode Identification)}",
...
writeLines(latex_lines, "Output/OECD_reg5.tex")