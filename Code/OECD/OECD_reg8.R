# Script: OECD_reg8.R
# Purpose: Regression 8 on OECD Episode Classification
# Input: Data/Clean Data/full_OECD_dataset.csv
# Output: Output/OECD_reg8.tex
...
latex_lines <- c(
  "\\begin{table}[!htbp]",
  "\\centering",
  "\\caption{Slippage after episode (OECD Episode Identification)}",
...
writeLines(latex_lines, "Output/OECD_reg8.tex")