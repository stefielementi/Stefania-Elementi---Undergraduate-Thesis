...
p <- ggplot(episodes, aes(x = share_current_exp_cuts, y = cum_adj)) +
  ...
  labs(
    title = "CAPB-Based Consolidation Episodes: Cumlative Fiscal Adjustment and Share of Current Expenditure Cuts",
...
ggsave(
  filename = "Figures/OECD_fig3.png",
  plot = p,
  width = 16,
  height = 10,
  dpi = 300
...
cat("Wrote: Figures/OECD_fig3.png")