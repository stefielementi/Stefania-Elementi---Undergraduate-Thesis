# Script: OECD_reg1.R
# Purpose: Regression 1 on OECD Episode Classification
# Input: Data/Clean Data/full_OECD_dataset.csv
# Output: Output/OECD_reg1.tex
...
latex_lines <- c(
  "\\begin{table}[!htbp]",
  "\\centering",
  "\\caption{Probability that a consolidation episode is started (OECD Episode Identification)}",
...
writeLines(latex_lines, "Output/OECD_reg1.tex")