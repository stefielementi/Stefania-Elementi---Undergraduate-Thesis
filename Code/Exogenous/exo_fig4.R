...
out_png <- "Figures/exo_fig4.png"
out_csv <- "Figures/exo_fig4.csv"
...
p <- ggplot(plot_df, aes(x = x_pos, y = mean_value, fill = episode_type)) +
  ...
  labs(
    title = "Response of long-term interest rates and policy rates during narrative-based episodes of fiscal consolidation",
    x = NULL,
    y = NULL,
    caption = paste0(
