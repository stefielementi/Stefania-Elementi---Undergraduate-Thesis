# Script: exo_reg7.R
# Purpose: Regression 7 on Exogenous Episode Classification
# Input: Data/Clean Data/full_gen.csv
# Output: Output/exo_reg7.tex
...
latex_lines <- c(
  "\\begin{table}[!htbp]",
  "\\centering",
  "\\caption{Length of adjustment episode (Exogenous Identification)}",
...
writeLines(latex_lines, "Output/exo_reg7.tex")