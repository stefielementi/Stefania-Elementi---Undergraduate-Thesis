# Script: exo_reg6.R
# Purpose: Regression 6 on Exogenous Episode Classification
# Input: Data/Clean Data/full_gen.csv
# Output: Output/exo_reg6.tex
...
latex_lines <- c(
  "\\begin{table}[!htbp]",
  "\\centering",
  "\\caption{Deceleration in the pace of debt accumulation (Exogenous Identification)}",
...
writeLines(latex_lines, "Output/exo_reg6.tex")