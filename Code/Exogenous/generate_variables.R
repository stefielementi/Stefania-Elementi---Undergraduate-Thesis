# Script: generate_variables.r
# Purpose: generate variables 
# Input: Data/Clean Data/raw_full.csv
# Output: Data/Clean Data/full_gen.csv
...
raw_full_MOD <- raw_full_MOD %>%
  ...
  mutate(
    # AFG plan indicator
    new_plan = tidyr::replace_na(as.numeric(`New Plan`), 0),
    
    # CAPB as % of potential GDP (same scale as in your old OECD episode code)
...
# 8 - Save Output
write.csv(raw_full_MOD, "Data/Clean Data/full_gen.csv", row.names = FALSE)