# Script: exo_reg4.R
# Purpose: Regression 4 on Exogenous Episode Classification
# Input: Data/Clean Data/full_gen.csv
# Output: Output/exo_reg4.tex
...
latex_lines <- c(
  "\\begin{table}[!htbp]",
  "\\centering",
  "\\caption{Probability of episode being seriously pursued after initial phase (Exogenous Identification)}",
...
writeLines(latex_lines, "Output/exo_reg4.tex")