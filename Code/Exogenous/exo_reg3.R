# Script: exo_reg3.R
# Purpose: Regression 3 on Exogenous Episode Classification
# Input: Data/Clean Data/full_gen.csv
# Output: Output/exo_reg3.tex
...
latex_lines <- c(
  "\\begin{table}[!htbp]",
  "\\centering",
  "\\caption{Size of yearly fiscal adjustment (Exogenous Identification)}",
  "\\label{tab:reg3_size}",
...
writeLines(latex_lines, "Output/exo_reg3.tex")